...
public class AppConstants {
    ...
    public static String url_backend_live = type_env.equals("dev") ? "http://localhost:3030" : "https://livestream-server-df2i.onrender.com";

    public static String url_frontend = type_env.equals("dev") ? "http://localhost:3000" : "https://thoaitranstore.vercel.app";

    public static String url_livestream = type_env.equals("dev") ? "http://localhost:3030" : "https://livestream-server-df2i.onrender.com";
